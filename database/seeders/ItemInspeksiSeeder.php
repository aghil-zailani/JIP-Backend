...
class ItemInspeksiSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $dataInspeksi = [
            ...
            'Eksterior' => [
                'Kap Mesin', 'Bumper Depan', 'Lampu Depan', 'Fender Depan Kiri','Pintu Depan Kiri',
                'Pilar A', 'Pilar B', 'Pilar C', 'Pintu Belakang Kiri', 'Quarter Kiri', 'Pintu Bagasi', 'End Panel', 'Stop Lamp',
